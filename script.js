const translations = {
      en: {
        ...
        step2Text: "Custom workflows are designed and implemented in n8n, tailored to your needs.",
        step3Title: "Testing & Handover",
        step3Text: "Workflows are tested, documented, and delivered with monitoring setup.",
      ...
      hu: {
        ...
        card2Text: "Kapcsoljon össze CRM-eket, táblázatokat, űrlapokat, webhookokat és API-kat. Ha HTTP-t használ, együtt tudjuk működtetni.",
        ...
        step1Title: "Felderítés és tervezés",
        ...
        step2Text: "Egyedi munkafolyamatokat tervezek és valósítok meg n8n-ben, az Ön igényeire szabva.",
        step3Title: "Tesztelés és átadás",
        step3Text: "A munkafolyamatokat teszteljük, dokumentáljuk és átadjuk felügyeleti beállításokkal.",
        contactTitle: "Kapcsolatfelvétel",
        contactText: "Van egy munkafolyamat-ötlete? Beszéljük meg, hogyan spórolhatunk meg munkaórákat egyedi automatizálással.",
        formName: "Az Ön neve",
...
document.getElementById('stack').addEventListener('submit', function(event) {
